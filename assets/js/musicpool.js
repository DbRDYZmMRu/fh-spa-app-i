              ...
              var Grade = (function() {
                ...
                },
                {
                  ...
                  value: function getCSSGradientProperty(top) {
                    const top1 = [top[1]];
                    var val1 = this.getRGBAGradientValues(top1);
    ...
    // Window load event for Grade initialization
    window.addEventListener("load", function() {
      Grade(document.querySelectorAll(".gradient-wrap"));
    });
    
    // DOMContentLoaded event for album container functionality
    document.addEventListener("DOMContentLoaded", function() {
      const albumContainers = document.querySelectorAll(".album-container");
      
      albumContainers.forEach((container) => {
        container.addEventListener("click", function() {
          const trackList = this.querySelector(".track-list");
