					...
					<div class="modal-content">
						<div class="modal-body p-0 bg-secondary rounded">
							<div class="p-5 text-center">
								<img class="img-fluid px-5" :src="store['resources']['global']['images']['cookies']" alt="">
								<h3>Cookies</h3>
								<p class="text-dark">
									<b>Frith Hilton</b>
									uses cookies to enhance user experience</p>
                    ...
                    fw-bold">Our policy</a>
								<div class="d-grid mt-5">
									...
									<p class="text-dark mt-4">Coupled with
										...
										<a href="https://github.com/vuejs/petite-vue" target="_blank" style="color: #42b883;">
											<b>petite-vue</b>
										</a>
									</p>
								</div>
